...
| Fundamental analysis states | Fundamental Analysis | `scripts/core/build_fundamental_analysis.py` | Future `data/processed/fundamental_analysis.csv` | Descriptive business/fundamental classification | Current | Produces row-preserving descriptive analysis states from Fundamental Quality and optional Fundamental Metrics inputs. Must not create allocation, ranking, conviction, urgency, or tradeability semantics. |
