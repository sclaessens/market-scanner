...
def run_command(
    ...
    *,
    ...
    try:
        ...
        output_dir = write_advice_outputs(
            advice_index,
        ...
        print(f"ERROR: unable to write advice outputs: {exc}", file=stderr)
        return 2
...
def _argument_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Produce deterministic Market Engine advice labels from a ticker "
            "status index."
        )
    )
